...
<div role="application" aria-label="YAML topology editor" aria-describedby="editor-help">
  <MonacoEditor ... />
</div>
<p id="editor-help" class="sr-only">Press F1 for command palette. Use arrow keys to navigate.</p>
```
