# Spec: Scenario Editor Guidelines

## Overview

Provide in-editor step-by-step guidance to help users successfully build and configure scenario topologies.
...
None - this is a new capability, not modifying existing behavior.
...
- `scenario-topology-validation` - Validation step referenced in guidelines
- `scenario-editor-infrastructure-selection` - First step references infrastructure selection
- `scenario-deployment-terminology` - Terminology consistency ("Deploy" in step 5)
