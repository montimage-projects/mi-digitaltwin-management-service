...
### Execute terminology removed

All "Execute" labels, buttons, and messaging are replaced with "Deploy" equivalents.

#### Scenario: Execute button removed from UI

- ScenarioDetail header "Execute" button is replaced with "Deploy"
- ScenarioTable "Execute" menu item is replaced with "Deploy"
- No execute-related buttons remain in scenario management UI
