...
const intactToolboxServices: ServiceSeed[] = [
  {
    ...
    interactsWith: ['MONT-MMT', 'UBI-ORCH'],
  ...
  },
  {
    ...
    interactsWith: ['MONT-NFZ', 'AIRBUS-ORION', 'UBI-ORCH', 'AEGIS-COS'],
  ...
  },
  {
    ...
    interactsWith: ['UBI-ORCH', 'HMU-DASH'],
  ...
  },
  {
    ...
    interactsWith: ['SIEMENS-PAC', 'UBI-ORCH'],
